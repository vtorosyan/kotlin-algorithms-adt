...
class WeightedQuickUnionBySizeWithPathCompressionUFTest {
    ...
    @Test
    fun `Weighted quick union by size with path compression returns correct number of components for a given pairs`() {
        val uf = WeightedQuickUnionBySizeWithPathCompressionUF(n)
