...
import com.example.algorithms.search.WeightedQuickUnionByRankWithPathCompressionUF
import com.example.algorithms.search.WeightedQuickUnionBySizeWithPathCompressionUF
import org.junit.Test
import kotlin.test.assertEquals
import kotlin.test.assertTrue

class WeightedQuickUnionByRankWithPathCompressionUFTest {
    private val n = 7
    ...
    @Test
    fun `Weighted quick union by rank with path compression returns correct number of components for a given pairs`() {
        val uf = WeightedQuickUnionByRankWithPathCompressionUF(n)
